...
print(sample_df.drop(['var_1', 'var_3'], axis=1))  #컬럼을 제거하려면 axix = 1
print(sample_df.drop(['var_1', 'var_2'], axix=1))
print(sample_df.drop(['a','b','c'], axix=0))    #행을 제거하려면 axis = 0
...
data = {
    ...
    'coment_length': [150, 200, 50, 300, 120, 180, 75, 160],
...
#print(iris.agg(['sum','mean',std']))       #class컬럼으로 인한 에러 발생
...
data = {
    ...
    'age' : [25, 30, 35, 28, 40],
    'salary' : [70000.00, 80000.00, 90000.00, 60000.00, 9500.00]
}